...
$barcode_include_header_text = 0; // change to 0 if dont want to use header in each barcode
...
$barcode_scale = 80; // barcode scale in percent relative to box width and height
